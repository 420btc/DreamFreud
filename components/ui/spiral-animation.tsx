...
class AnimationController {
    ...
    private readonly startDotYOffset = -450 // Ajustado para subir la animación
    ...
    // Configurar la línea de tiempo de la animación
    private setupTimeline() {
        ...
        // Crear una nueva línea de tiempo con duración de 10 segundos
        this.timeline = gsap.timeline({
            repeat: 0,  // No repetir
            onUpdate: () => this.render()
        });
        
        // Configurar la animación para que dure 10 segundos
        ...
        // Repetir la animación para que dure indefinidamente
...
const SpiralAnimation = () => {
    ...
    // Crear y gestionar la animación
    useEffect(() => {
        const initAnimation = () => {
            ...
            // Configurar DPR para pantalla nítida
            const dpr = window.devicePixelRatio || 1;
            
            // Obtener el tamaño completo de la ventana
            ...
            // Ajustar el tamaño CSS del canvas
